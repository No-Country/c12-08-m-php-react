            ...
            <td align="center" valign="top">
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%" bgcolor="#4dbfbf">
                  <tr>
                    <td>
                        <br>
                        <img src="https://i.imgur.com/XKL4WJL.png" alt="pillcare" style="height: 150px; width:150px">
                    </td>
                  </tr>
                  <tr>
                    <td class="headline">
                      ...
                      <center>
                        <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                          <tr>
                            ...
                            Hola, {{$name}}
                                <br><br>
                        We can't wait to read your guides! We will be in touch soon!
                            <br>
                            <br>

<br><br>
																			You can really help us out by sharing with your friends: {REFURL}<br><br>
                            </td>
                          </tr>
                        </table>
                      </center>
                ...
                <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" class="force-full-width" bgcolor="#414141" style="margin: 0 auto">
                  ...
                  <tr>
                    <td style="color:#bbbbbb; font-size:12px;">
                        <a href="mail:pillcare.c12@gmail.com">Contacto</a>                      <br><br>
                    </td>
                  </tr>
                  <tr>
                    <td style="color:#bbbbbb; font-size:12px;">
